...
CREATE TABLE `employee` (
  ...
  `login_user` varchar(60) CHARACTER SET utf8 NOT NULL,
  `active_key` text CHARACTER SET utf8 NOT NULL,
  `referto` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `orders` (
  ...
  `ship_address` text CHARACTER SET utf8,
...
CREATE TABLE `products` (
  ...
  `flavor` varchar(60) CHARACTER SET utf8 NOT NULL,
...
(1, '1', '加多宝凉茶植物饮料', '36.90 加多宝凉茶植物饮料盒装250ml*24 箱装.jpg', '加多宝', 5, 'default', '250ml*24', '36.90 加多宝凉茶植物饮料盒装250ml*24 箱装.jpg', 36.90, '2018-06-02', '2017-06-02', 36.90, 332),
(2, '2', '可口可乐330ml', '38.80 可口可乐330ml*24听整箱.jpg', '可口可乐', 4, 'default', '330ml*24', '38.80 可口可乐330ml*24听整箱.jpg', 38.80, '2018-06-01', '2017-06-01', 38.80, 55),
(3, '3', '锐澳（RIO）洋酒 鸡尾酒', '75.00 锐澳（RIO）洋酒 鸡尾酒 预调酒果酒混合装（六种口味）275ml*6瓶.jpg', '锐澳', 7, 'default', '275ml*6', '75.00 锐澳（RIO）洋酒 鸡尾酒 预调酒果酒混合装（六种口味）275ml*6瓶.jpg', 75.00, '2018-06-09', '2017-06-09', 75.00, 1),
(4, '4', '雪碧 330ml', '38.80 雪碧 330ml*24听箱.jpg', '雪碧', 4, 'default', '330ml*24', '38.80 雪碧 330ml*24听箱.jpg', 38.80, '2018-06-09', '2017-06-09', 38.80, 5),
(5, '5', '芬达碳酸饮料', '39.80 芬达碳酸饮料330ml*24听 整箱.jpg', '芬达', 4, 'default', '330ml*24', '39.80 芬达碳酸饮料330ml*24听 整箱.jpg', 39.80, '2018-06-09', '2017-06-09', 39.80, 6),
(6, '6', '雪碧 500ml', '59.90 雪碧 500ml*24箱.jpg', '雪碧', 4, 'default', '500ml*24', '59.90 雪碧 500ml*24箱.jpg', 59.00, '2018-06-09', '2017-06-09', 59.00, 9),
(7, '7', '养元', '61.90 养元240ml*20.jpg', '养元', 6, 'default', '240ml*20', '61.90 养元240ml*20.jpg', 61.90, '2018-06-09', '2017-06-09', 61.90, 8),
...
(23, '23', 'knoppers 牛奶巧克力榛子威化饼干', '69.90 knoppers 牛奶巧克力榛子威化饼干 600g盒 德国进口.jpg', 'knoppers', 8, 'default', '600g盒', '69.90 knoppers 牛奶巧克力榛子威化饼干 600g盒 德国进口.jpg', 69.90, '2018-11-04', '2017-11-04', 69.90, 733),
(24, '24', '丹麦进口 Kjeldsens 丹麦蓝罐 曲奇饼干 礼盒 ', '99.00 丹麦进口 Kjeldsens 丹麦蓝罐 曲奇饼干 礼盒 908g 盒装.jpg', 'Kjeldsens', 8, 'default', '908g盒', '99.00 丹麦进口 Kjeldsens 丹麦蓝罐 曲奇饼干 礼盒 908g 盒装.jpg', 99.00, '2018-11-04', '2017-11-04', 99.00, 34621),
(25, '25', '法国进口 巴黎水Perrier气泡矿泉水 原味 玻璃瓶装1箱 ', '139.00 法国进口 巴黎水Perrier气泡矿泉水 原味 玻璃瓶装1箱 330MLx24瓶.jpg', 'Perrier', 5, 'default', '330MLx24瓶', '139.00 法国进口 巴黎水Perrier气泡矿泉水 原味 玻璃瓶装1箱 330MLx24瓶.jpg', 139.00, '2018-11-04', '2017-11-04', 139.00, 1235),
(26, '26', '浓情厚礼·品味装806g 四川成都特产牛肉干礼盒大礼包送礼', '158.00 浓情厚礼·品味装806g 四川成都特产牛肉干礼盒大礼包送礼.jpg', '四川成都特产', 7, 'default', '806g', '158.00 浓情厚礼·品味装806g 四川成都特产牛肉干礼盒大礼包送礼.jpg', 158.00, '2018-11-04', '2017-11-04', 158.00, 299),
(27, '27', '中国台湾进口张君雅小妹妹休闲丸子（日式风味）80g', '7.5 中国台湾进口张君雅小妹妹休闲丸子（日式风味）80g.jpg', '张君雅', 7, '日式风味', '80g', '7.5 中国台湾进口张君雅小妹妹休闲丸子（日式风味）80g.jpg', 7.50, '2018-11-04', '2017-11-04', 7.50, 299),
(28, '28', '马来西亚进口 马奇新新 巧克力夹心巧心卷饼干 80g 鸡蛋卷酥 休闲零食', '9.9 马来西亚进口 马奇新新 巧克力夹心巧心卷饼干 80g 鸡蛋卷酥 休闲零食.jpg', '马来西亚进口 ', 8, 'default', '80g', '9.9 马来西亚进口 马奇新新 巧克力夹心巧心卷饼干 80g 鸡蛋卷酥 休闲零食.jpg', 9.90, '2018-11-04', '2017-11-04', 9.90, 299),
(29, '29', '泰国进口 休闲零食 小老板 烤海苔卷 脆紫菜卷 原味 32.4g盒', '14.80 泰国进口 休闲零食 小老板 烤海苔卷 脆紫菜卷 原味 32.4g盒.jpg', '泰国进口', 8, 'default', '32.4g盒', '14.80 泰国进口 休闲零食 小老板 烤海苔卷 脆紫菜卷 原味 32.4g盒.jpg', 14.80, '2018-11-04', '2017-11-04', 14.80, 299),
(30, '30', '印尼进口 丽芝士 休闲零食 Richeese 纳宝帝 奶酪味 威化饼干 350g罐', '23.8 印尼进口 丽芝士 休闲零食 Richeese 纳宝帝 奶酪味 威化饼干 350g罐.jpg', '印尼进口', 8, '奶酪味', '350g罐', '23.8 印尼进口 丽芝士 休闲零食 Richeese 纳宝帝 奶酪味 威化饼干 350g罐.jpg', 23.80, '2018-11-04', '2017-11-04', 23.80, 299),
(31, '31', '葡韵手信 澳门特色 休闲零食 传统糕点小吃 千层酥150g', '25.00 葡韵手信 澳门特色 休闲零食 传统糕点小吃 千层酥150g.jpg', '葡韵手信', 8, 'default', '150g', '25.00 葡韵手信 澳门特色 休闲零食 传统糕点小吃 千层酥150g.jpg', 25.00, '2018-11-04', '2017-11-04', 25.00, 299),
(32, '32', '韩国进口海牌海苔2g*32包', '36.90 韩国进口海牌海苔2g*32包.jpg', '韩国进口', 8, 'default', '2g*32包', '36.90 韩国进口海牌海苔2g*32包.jpg', 36.00, '2018-11-04', '2017-11-04', 36.00, 299),
(33, '33', '泰国进口Durian Monthong榴的华金枕头榴莲干100g', '41.90 泰国进口Durian Monthong榴的华金枕头榴莲干100g.jpg', '泰国进口', 8, 'default', '100g', '41.90 泰国进口Durian Monthong榴的华金枕头榴莲干100g.jpg', 41.90, '2018-11-04', '2017-11-04', 41.90, 299),
(34, '34', '美国进口 万多福（Wonderful）加州开心果 经典盐焗味668g', '99.00 美国进口 万多福（Wonderful）加州开心果 经典盐焗味668g.jpg', '美国进口', 8, '盐焗味', '668g', '99.00 美国进口 万多福（Wonderful）加州开心果 经典盐焗味668g.jpg', 99.00, '2018-11-04', '2017-11-04', 99.00, 299),
(35, '35', '美国进口 绅士牌(Planters)精选大罐混合坚果（腰果、巴旦木、碧根果、巴西果、榛...', '119.00 美国进口 绅士牌(Planters)精选大罐混合坚果（腰果、巴旦木、碧根果、巴西果、榛子）963g.jpg', '美国进口 ', 8, 'default', '963g', '119.00 美国进口 绅士牌(Planters)精选大罐混合坚果（腰果、巴旦木、碧根果、巴西果、榛子）963g.jpg', 119.00, '2018-11-04', '2017-11-04', 119.00, 299),
(36, '36', '日本进口Calbee卡乐比薯条三兄弟180g*2盒 北海道卡乐B进口休闲零食品', '155.00 日本进口Calbee卡乐比薯条三兄弟180g*2盒 北海道卡乐B进口休闲零食品.jpg', '日本进口', 8, 'default', '180g*2盒', '155.00 日本进口Calbee卡乐比薯条三兄弟180g*2盒 北海道卡乐B进口休闲零食品.jpg', 155.00, '2018-11-04', '2017-11-04', 155.00, 299),
(37, '37', '茅台集团 习酒 红习酱1952 53度 单瓶装白酒500ml 口感酱香型', '78.00 茅台集团 习酒 红习酱1952 53度 单瓶装白酒500ml 口感酱香型.jpg', '茅台', 7, '酱香', '53度 500ml', '78.00 茅台集团 习酒 红习酱1952 53度 单瓶装白酒500ml 口感酱香型.jpg', 78.00, '2018-11-04', '2017-11-04', 78.00, 299),
(38, '38', '洋河蓝色经典 海之蓝 52度 480ml 口感绵柔浓香型', '156.00 洋河蓝色经典 海之蓝 52度 480ml 口感绵柔浓香型.jpg', '海之蓝', 7, '浓香', '52度 480ml', '156.00 洋河蓝色经典 海之蓝 52度 480ml 口感绵柔浓香型.jpg', 156.00, '2018-11-04', '2017-11-04', 156.00, 299),
(39, '39', '茅台集团 习酒 红习酱359.00 1952 53度500ml*6瓶 整箱装白酒 口感...', '359.00 茅台集团 习酒 红习酱359.00 1952 53度500ml*6瓶 整箱装白酒 口感酱香型.jpg', '茅台', 7, '酱香', '53度 500ml*6瓶', '359.00 茅台集团 习酒 红习酱359.00 1952 53度500ml*6瓶 整箱装白酒 口感酱香型.jpg', 359.00, '2018-11-04', '2017-11-04', 359.00, 299),
(40, '40', '剑南春 水晶剑 52度 单瓶装白酒 500ml 口感浓香型', '378.00 剑南春 水晶剑 52度 单瓶装白酒 500ml 口感浓香型.jpg', '剑南春 ', 7, '浓香', '52度 500ml', '378.00 剑南春 水晶剑 52度 单瓶装白酒 500ml 口感浓香型.jpg', 378.00, '2018-11-04', '2017-11-04', 378.00, 299),
(41, '41', '茅台 迎宾 53度 整箱装白酒 500ml*6瓶 口感酱香型', '468.00 茅台 迎宾 53度 整箱装白酒 500ml*6瓶 口感酱香型.jpg', '茅台', 7, '酱香', '500ml*6瓶', '468.00 茅台 迎宾 53度 整箱装白酒 500ml*6瓶 口感酱香型.jpg', 468.00, '2018-11-04', '2017-11-04', 468.00, 299),
(42, '42', '法国进口红酒 拉菲（LAFITE）传奇波尔多干红葡萄酒 750ml（ASC', '88.00 法国进口红酒 拉菲（LAFITE）传奇波尔多干红葡萄酒 750ml（ASC）.jpg', '法国进口', 7, 'default', '750ml', '88.00 法国进口红酒 拉菲（LAFITE）传奇波尔多干红葡萄酒 750ml（ASC）.jpg', 88.00, '2018-11-04', '2017-11-04', 88.00, 299),
(43, '43', '法国进口红酒 克鲁斯大帝干红葡萄酒双支礼盒装带酒具 750ml*2瓶', '108.00 法国进口红酒 克鲁斯大帝干红葡萄酒双支礼盒装带酒具 750ml*2瓶.jpg', '法国进口', 7, 'default', '750ml*2瓶', '108.00 法国进口红酒 克鲁斯大帝干红葡萄酒双支礼盒装带酒具 750ml*2瓶.jpg', 108.00, '2018-11-04', '2017-11-04', 108.00, 299),
(44, '44', '长城（GreatWall）红酒 特酿3年解百纳干红葡萄酒 整箱装 750ml*6瓶', '148.00 长城（GreatWall）红酒 特酿3年解百纳干红葡萄酒 整箱装 750ml*6瓶.jpg', '长城', 7, 'default', '750ml*6瓶', '148.00 长城（GreatWall）红酒 特酿3年解百纳干红葡萄酒 整箱装 750ml*6瓶.jpg', 148.00, '2018-11-04', '2017-11-04', 148.00, 299);
